...
public class StoreSignOnEventAsyncTask extends AsyncTask<Void, Void, Void> {

    private Context context;

    public StoreSignOnEventAsyncTask(Context context) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        // Store SignOnEvent on server
        final String url = EnvironmentSettings.getBaseUrl() + "/rest/v2/sign-on-events/create" +
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, (String) null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            GoogleAnalyticsHelper.trackEvent(context, "signon", "signon_store_event_exception", e.getClass().getName() + "_" + e.getMessage() + "_" + url);
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    GoogleAnalyticsHelper.trackEvent(context, "signon", "signon_store_event_volleyerror", error.getClass().getName() + "_" + error.getMessage() + "_" + url);
                    }
                }
        );
