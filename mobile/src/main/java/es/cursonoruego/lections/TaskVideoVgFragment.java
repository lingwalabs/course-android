...
public class TaskVideoVgFragment extends Fragment {
    ...
    public static TaskVideoVgFragment newInstance(TaskJson task) {
        TaskVideoVgFragment fragment = new TaskVideoVgFragment();
        fragment.task = task;
        return fragment;
    }

    public TaskVideoVgFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_task_video_vg, container, false);
    ...
    public void onStart() {
        ...
        String iframeUrl = "http://www.vgtv.no/embed/?id=" + task.getYouTubeId();
