...
public class TaskVideoAftenpostenFragment extends Fragment {
    ...
    public static TaskVideoAftenpostenFragment newInstance(TaskJson task) {
        TaskVideoAftenpostenFragment fragment = new TaskVideoAftenpostenFragment();
        fragment.task = task;
        return fragment;
    }

    public TaskVideoAftenpostenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_task_video_aftenposten, container, false);
    ...
    public void onStart() {
        ...
        String iframeUrl = "http://www.aftenposten.no/webtv/embed/?id=" + task.getYouTubeId();
