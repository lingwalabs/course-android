...
public class StorePaymentEventAsyncTask extends AsyncTask<Object, Void, Void> {

    private Context context;

    public StorePaymentEventAsyncTask(Context context) {
    ...
    protected Void doInBackground(Object... objects) {
        ...
        final String url = EnvironmentSettings.getBaseUrl() + "/rest/v2/payment-events/create" +
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, (String) null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            GoogleAnalyticsHelper.trackEvent(context, "payment", "payment_store_event_exception", e.getClass().getName() + "_" + e.getMessage() + "_" + url);
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        GoogleAnalyticsHelper.trackEvent(context, "payment", "payment_store_event_volleyerror", error.getClass().getName() + "_" + error.getMessage() + "_" + url);
                    }
                }
        );
