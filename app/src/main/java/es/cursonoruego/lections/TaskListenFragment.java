...
public class TaskListenFragment extends Fragment {
    ...
    private ImageButton mImageButtonPlayAudio;
...
//    private PlayAudioAsyncTask playAudioAsyncTask;
    ...
    public static TaskListenFragment newInstance(TaskJson task) {
        TaskListenFragment fragment = new TaskListenFragment();
        fragment.task = task;
        return fragment;
    }

    public TaskListenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_task_listen, container, false);
        ...
        mImageButtonPlayAudio = (ImageButton) rootView.findViewById(R.id.task_play_audio_button);
...
//        playAudioAsyncTask = new PlayAudioAsyncTask(getActivity());
    ...
    public void onStart() {
        ...
        // TODO: do not enable continue/previous buttons until Audio has finished downloading? (implement onButtonPressed())
        new PlayAudioAsyncTask(getActivity()).execute(task.getMp3FileName());
        mImageButtonPlayAudio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(getClass().getName(), "onClick (mImageButtonPlayAudio)");
                new PlayAudioAsyncTask(getActivity()).execute(task.getMp3FileName());
            }
        });
