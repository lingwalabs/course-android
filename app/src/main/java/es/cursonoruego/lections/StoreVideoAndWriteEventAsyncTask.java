...
public class StoreVideoAndWriteEventAsyncTask extends AsyncTask<Object, Void, Void> {

    private Context context;

    public StoreVideoAndWriteEventAsyncTask(Context context) {
    ...
    protected Void doInBackground(Object... objects) {
        ...
        final String url = EnvironmentSettings.getBaseUrl() + "/rest/v2/task-events/create/" + TaskType.VIDEO_AND_WRITE +
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, (String) null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            GoogleAnalyticsHelper.trackEvent(context, "task", "task_store_video_and_write_event_exception", e.getClass().getName() + "_" + e.getMessage() + "_" + url);
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        GoogleAnalyticsHelper.trackEvent(context, "task", "task_store_video_and_write_event_volleyerror", error.getClass().getName() + "_" + error.getMessage() + "_" + url);
                    }
                }
        );
