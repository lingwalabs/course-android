...
public class StoreListenAndWriteEventAsyncTask extends AsyncTask<Object, Void, Void> {

    private Context context;

    public StoreListenAndWriteEventAsyncTask(Context context) {
    ...
    protected Void doInBackground(Object... objects) {
        ...
        String valueWritten = (String) objects[2];
        try {
            valueWritten = URLEncoder.encode(valueWritten, "UTF-8");
        } catch (UnsupportedEncodingException e) {
            Log.e(getClass().getName(), null, e);
        }

        final String url = EnvironmentSettings.getBaseUrl() + "/rest/v2/task-events/create/" + TaskType.LISTEN_AND_WRITE +
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, (String) null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            GoogleAnalyticsHelper.trackEvent(context, "task", "task_store_listen_and_write_event_exception", e.getClass().getName() + "_" + e.getMessage() + "_" + url);
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        GoogleAnalyticsHelper.trackEvent(context, "task", "task_store_listen_and_write_event_volleyerror", error.getClass().getName() + "_" + error.getMessage() + "_" + url);
                    }
                }
        );
